                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          アドミンサポートのリクエストがありました. 
                        </td>
                      </tr>
                        
                      <tr>
                        <td style="padding: 0 0 60px;">
                          <a style="display: flex; padding: 28px 24px; border-radius: 4px; background-color: #FFF9F9; text-decoration: none;">
                            <span style="width: 90%; font-size: 14px; line-height: 150%; font-weight: bold; color: #29426E; letter-spacing: 0.01em;">
                               {{trans("lang.register_id", [], 'ja')}} : {{auth()->user()->id}}<br>
                                 {{trans("lang.name", [], 'ja')}}: {{auth()->user()->fullName}}<br>
                                {{trans("lang.phone", [], 'ja')}}: {{auth()->user()->phone}}<br>
                                {{trans("lang.email", [], 'ja')}}: {{auth()->user()->email}}<br>
                                 {{trans("lang.chat_room_id", [], 'ja')}}:{{$chatroom->id}}
                                </span>
                          </a>
                        </td>
                      </tr>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  ...
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">OUR WORKS CO.,LTD.
                    </div>
                  </div>
