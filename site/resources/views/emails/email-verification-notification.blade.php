                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Thanks for choosing Job Matchy! We are happy to see you on board. <br> To verify your email please click the button below or copy the link.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 0 0 24px 0;">
                          <a class="button" href="{{$link}}" title="Reset Password" style="width: 100%; background: #4C83EE; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Confirm</a>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                           {{ env('APP_URL').'verify/email' }}
                        </td>
                      </tr>
                      <tr>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  ...
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Our Works<br/>HAMAMATSUCHO DIA BLDG. 2F.,2-2-15, HAMAMATSUCHO,MINATO-KU,TOKYO
                    </div>
                  </div>
