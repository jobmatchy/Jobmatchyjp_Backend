...
use App\Listeners\V1\AppleStoreEventListener;
use App\Listeners\V1\AppStoreCancelListener;
use App\Listeners\V1\AppStoreDidRenewListener;
use App\Listeners\V1\GoogleStoreEventListener;
use App\Listeners\V1\GoogleStoreSubscriptionCancelListener;
use App\Listeners\V1\GoogleStoreSubscriptionRenew;
    ...
    */
    'eventListeners' => [
        ...
        /*
         ...
         | @see @see https://imdhemy.com/laravel-iap-docs/docs/serxver-notifications/event-list#google-play-events
         */

         Imdhemy\Purchases\Events\GooglePlay\SubscriptionPurchased::class =>[
            GoogleStoreEventListener::class
         ],
         Imdhemy\Purchases\Events\GooglePlay\SubscriptionRenewed::class =>[
            GoogleStoreSubscriptionRenew::class
         ],
         Imdhemy\Purchases\Events\GooglePlay\SubscriptionCanceled::class =>[
            GoogleStoreSubscriptionCancelListener::class
         ]
