...
//            'job.pay_type' => 'required|in:hour,day,month,year,outsourcing',
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'job.skill_up.boolean' => __('validation.boolean', [], $lang),
            'job.station_chika.boolean' => __('validation.boolean', [], $lang),
            'job.accomodation.boolean' => __('validation.boolean', [], $lang),
            'job.five_days_working.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
            'job.uniform_provided.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
            'job.english_required.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
            'job.social_insurance.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
            'job.urgent_recruitment.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
            'job.men_preferred.boolean' => __('validation.boolean', [], $lang),
            'job.women_preferred.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
            'job.education.boolean' => __('validation.boolean', [], $lang),
            'job.training.boolean' => __('validation.boolean', [], $lang),
            'job.pay_raise.boolean' => __('validation.boolean', [], $lang),
            'job.experience_required.boolean' => __(
                'validation.boolean',
                [],
                $lang
            ),
