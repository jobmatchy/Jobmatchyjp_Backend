...
namespace App\Modules\V1\Jobseeker\Services;

use App\Modules\V1\Auth\Traits\RegistrationTrait;
use App\Modules\V1\Jobseeker\Models\Jobseeker;
    ...
    public function filter($request)
    {
        ...
        if ($user->user_type == 2) {
            ...
            return $jobseekers
                ...
                ->whereDoesntHave('matching', function ($matchingQuery) use ($user) {
