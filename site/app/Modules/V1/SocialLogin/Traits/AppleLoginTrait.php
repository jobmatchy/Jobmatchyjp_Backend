...
namespace App\Modules\V1\SocialLogin\Traits;
...
trait AppleLoginTrait
{
    ...
    public function getLocalUser(OAuthTwoUser $socialUser, $lang): ?User
    {
    ...
    public function registerAppleUser(OAuthTwoUser $socialUser, $lang): ?User
    {
        $user = User::create([
